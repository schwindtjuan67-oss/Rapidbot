...
"""
Adapter Binance SPOT 5m downloader for LTCUSDC.

Usage (Windows PowerShell):
  python -m scripts.bt_spot_ltc_usdc --start 2017-01-01 --end 2026-02-13
"""
...
def _build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Download Binance SPOT LTCUSDC 5m candles into the repo dataset layout.")
