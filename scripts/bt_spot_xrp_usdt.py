...
"""
Adapter Binance SPOT 5m downloader for XRPUSDT.

Usage (Windows PowerShell):
  python -m scripts.bt_spot_xrp_usdt --start 2017-01-01 --end 2026-02-13
"""
...
def _build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Download Binance SPOT XRPUSDT 5m candles into the repo dataset layout.")
